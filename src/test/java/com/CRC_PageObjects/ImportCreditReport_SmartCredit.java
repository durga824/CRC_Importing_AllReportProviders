...
public class ImportCreditReport_SmartCredit extends AbstractClass
{
	...
	public WebElement getChooseSupportProviderDropDown()
	{
		...
		select_dropdown_by_value(ChooseSupportProviderDropDown, "SmartCredit");
	...
	public WebElement getUsername()
	{
		...
		send_text(Username, Reading_Values.prop.getProperty("SmartCreditUsername"));
		return Username;
	}
	...
	public WebElement getPassword()
	{
		...
		send_text(Password, Reading_Values.prop.getProperty("SmartCreditPassword"));
		return Password;
	}
