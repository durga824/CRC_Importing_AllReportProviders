...
public class ImportCreditReport_PrivacyGuard extends AbstractClass
{
	...
	@FindBy(how = How.XPATH, using = "//h1[normalize-space()='Encountered an error when importing']")
	static WebElement EncounteredAnErrorMessage;
	
	@FindBy(how = How.XPATH, using = "//div[@id='auto_error_div']")
	static WebElement ErrorMessageContainer;
	
	@FindBy(how = How.XPATH, using = "//div[@id='auto_error_msg']//p[1]")
	static WebElement SystemErrorMessage;
	...
	public WebElement getChooseSupportProviderDropDown()
	{
		...
		select_dropdown_by_value(ChooseSupportProviderDropDown, "PrivacyGuard ");
	...
	public WebElement getUsername()
	{
		...
		send_text(Username, Reading_Values.prop.getProperty("PrivacyGuardUsername"));
		return Username;
	}
	...
	public WebElement getPassword()
	{
		...
		send_text(Password, Reading_Values.prop.getProperty("PrivacyGuardPassword"));
		return Password;
	}
	...
	public WebElement getErrorMessageContainer()
	{
		...
		waitForElement(EncounteredAnErrorMessage);
		if (EncounteredAnErrorMessage.isDisplayed())
		{
			System.out.println(SystemErrorMessage.getText());			
		}
